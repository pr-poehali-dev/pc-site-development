...
const warranties = [
  ...
  { icon: 'Headphones', title: 'Быстрая поддержка', text: 'Живые инженеры на связи с 11 до 22 по Московскому времени' },
];
  ...
  return (
    <Layout>
      <SEO
        ...
        description="Собираем мощные игровые и рабочие ПК на заказ под ваши задачи. Индивидуальный подбор комплектующих, гарантия до 3 лет от мастерской и до 10 лет на комплектующие, доставка по России и СНГ. Оставьте заявку!"
        path="/"
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 pointer-events-none flex">
          <img
            ...
            alt=""
            aria-hidden
            className="w-1/2 h-full object-cover object-center opacity-40 blur-sm"
          />
          <img
      ...
      {/* FAQ */}
      <section className="relative z-10 container pt-6 md:pt-8 pb-6 md:pb-8 max-w-3xl">
      ...
      <section className="relative z-10 container pb-2 md:pb-4">
        <div className="grid md:grid-cols-2 gap-4 md:gap-6">
          <div className="relative p-4 md:p-7 text-center flex flex-col">
            ...
            <p className="text-muted-foreground text-sm mb-6 max-w-md mx-auto">Подберём идеальную сборку под твои задачи и бюджет за 25 минут.</p>
