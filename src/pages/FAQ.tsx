  ...
  return (
    <Layout>
      <SEO
        ...
        description="Ответы на частые вопросы: как заказать сборку ПК, сроки, доставка по России и СНГ, гарантия до 3 лет от мастерской и до 10 лет на комплектующие, оплата, trade-in. Всё о работе White Friday PC."
        path="/faq"
        jsonLd={[
          faqLd,
          breadcrumbLd([
