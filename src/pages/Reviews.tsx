        ...
        <div className="max-w-3xl mx-auto animate-fade-up">
          ...
          <div className="space-y-5 text-muted-foreground leading-relaxed">
            ...
            <div>
              ...
              <p>Мы продолжаем заниматься этим проектом вдвоём, растим оборот, привлекаем клиентов своим подходом в общении и честности, а также тем, что никогда не оставляем человека в сложной ситуации в случае каких-то проблем.</p>
            </div>
